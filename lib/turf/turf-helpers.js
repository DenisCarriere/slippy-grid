 ...
 * //=polygon
 */
export function polygon (coordinates, properties) {
 ...
 *
 */
export function multiLineString (coordinates, properties) {
  if (!coordinates) {
    throw new Error('No coordinates passed')
  }
  return feature({
 ...
 *
 */
export function multiPoint (coordinates, properties) {
  if (!coordinates) {
    throw new Error('No coordinates passed')
  }
  return feature({
 ...
 *
 */
export function multiPolygon (coordinates, properties) {
  if (!coordinates) {
    throw new Error('No coordinates passed')
  }
  return feature({
 ...
 * //=collection
 */
export function geometryCollection (geometries, properties) {
  return feature({
